        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2 md:space-x-3">
              ...
              <div>
                <h1 className="text-lg md:text-xl font-bold text-gray-800 dark:text-white">DART-PAYROLL</h1>
                <p className="text-xs text-gray-500 dark:text-gray-400">Friday, November 7, 2025</p>
              </div>
            </div>
          </div>
          
          <div className="flex items-center space-x-2 md:space-x-4">
            <button className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors relative hidden md:block">
            ...
            <div className="flex items-center space-x-2 md:space-x-3 pl-3 border-l border-gray-200 dark:border-gray-700">
