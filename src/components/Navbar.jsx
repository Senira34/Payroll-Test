        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2 md:space-x-3">
              ...
              <div>
                <h1 className="text-lg md:text-2xl font-bold text-gray-800 dark:text-white">DART-PAYROLL</h1>
                <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">Friday, November 7, 2025</p>
              </div>
            </div>
          </div>
