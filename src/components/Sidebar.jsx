...
const Sidebar = ({ sidebarOpen }) => {
  return (
    <aside className={`${sidebarOpen ? 'w-56 lg:w-64' : 'w-0'} transition-all duration-300 overflow-hidden bg-gradient-to-b from-blue-600 to-purple-700 dark:from-gray-800 dark:to-gray-900 min-h-screen shadow-xl flex-shrink-0`}>
